...
class FavoriteAdapter(private var data: List<Favorite>,
                     private val listener: (Favorite) -> Unit)
    : RecyclerView.Adapter<FavoriteAdapter.LeagueViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LeagueViewHolder {
        ...
        val inflatedView: View = layoutInflater.inflate(R.layout.row_item_favorite, parent, false)
