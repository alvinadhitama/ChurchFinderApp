...
import com.alvin.churchfinderapp.edit.EditEmailActivity
import com.alvin.churchfinderapp.edit.EditPasswordActivity
import com.alvin.churchfinderapp.edit.EditProfileActivity
import com.alvin.churchfinderapp.features.Feature1Activity
...
//            mDatabase2 =  FirebaseDatabase.getInstance().getReference("Church/Kidul Loji")
//            mDatabase2.addListenerForSingleValueEvent(object : ValueEventListener{
//                override fun onCancelled(databaseError: DatabaseError) {
//                }
//
//                override fun onDataChange(dataSnapshot: DataSnapshot) {
//                    FirebaseDatabase.getInstance().getReference("Popular/Kidul Loji")
